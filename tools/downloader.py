...
class Downloader:
    ...
    def process_item(
        ...
        runtime eligibility check is performed here. This relies on the
        assumption that the IDs CSV is always freshly generated by get-ids-es
        as part of the chained pipeline — not a stale or manually-created file.
        """
